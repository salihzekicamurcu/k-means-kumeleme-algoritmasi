...
m1=[randi([1,31],1,1),randi([1,12],1,1),randi([0,1],1,1)];
m2=[randi([1,31],1,1),randi([1,12],1,1),randi([1,5],1,1)];
m3=[randi([1,31],1,1),randi([1,12],1,1),randi([2,3],1,1)];
...
for i=1:boyut(1)
        ...
        for j=1:k
            u=uzalikHesap(m(i,:),noktalar);
            uzakliklar=[uzakliklar;u,j];
        end
        ...
        aitlik=uzakliklar(1,2);
         gruplar=[gruplar;noktalar,aitlik    
...
for s=1:2000
    ...
    for i=1:boyut(1)
        ...
        u1=uzaklikHesap(m1,noktalar);
        uzakliklar=[uzakliklar;u1,1];
        
        u2=uzaklikHesap(m2,noktalar);
        uzakliklar=[uzakliklar;u2,2];
        
        u3=uzaklikHesap(m3,noktalar);
